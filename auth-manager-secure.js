  ...
  async init() {
    ...
    if (isLoggedIn) {
      ...
      if (
        ...
        typeof window.adminPanelInstance.onAuthSuccess === "function"
      ) {
  ...
  async login(password) {
    try {
      ...
      if (isValidPassword) {
        ...
        setTimeout(() => {
          if (
            window.adminPanelMedia &&
            typeof window.adminPanelMedia.onAuthSuccess === "function"
          ) {
            window.adminPanelMedia.onAuthSuccess();
          }
        }, 100);
